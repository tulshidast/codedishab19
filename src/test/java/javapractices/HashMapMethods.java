...
public class HashMapMethods {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, String> studentInfo2 = new HashMap<>();
		studentInfo2.put(7, "Alice");
		studentInfo2.put(8, "Bob");

		// putAll method is used to add all key-value pairs from one HashMap to another
		...
		// containsKey method is used to check if a specific key exists in the HashMap
		...
		// isEmpty method is used to check if the HashMap is empty or not and returns a
		// boolean value (true or false)
		System.out.println("is studentInfo empty : " + studentInfo.isEmpty()); // returns false because the HashMap is
																				// not empty
		...
		System.out.println("######################################################################");
		// remove method is used to remove a key-value pair from the HashMap based on
		...
		// in the HashMap as Map.Entry objects
		...
		System.out.println("######################################################################");
		studentInfo.clear(); // clear method is used to remove all key-value pairs from the HashMap, making
								// it empty
