...
public class TreeMapMethods {
	...
	public static void main(String[] args) {
		...
		TreeMap<Integer, String> studentInfo = new TreeMap<>();

		// put method is used to add key-value pairs to the TreeMap
		...
		TreeMap<Integer, String> studentInfo2 = new TreeMap<>();
		studentInfo2.put(7, "Alice");
		studentInfo2.put(8, "Bob");

		// putAll method is used to add all key-value pairs from one TreeMap to
		// another
		...
		// isEmpty method is used to check if the TreeMap is empty or not and
		// returns a
		...
		System.out.println("######################################################################");
		// remove method is used to remove a key-value pair from the TreeMap based
		// on
		...
		// in the TreeMap as Map.Entry objects
		...
		System.out.println("######################################################################");
		studentInfo.clear(); // clear method is used to remove all key-value pairs from the TreeMap,
								// making
								// it empty
